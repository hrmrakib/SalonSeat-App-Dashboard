    ...
    <header className="sticky top-0 z-30 bg-white border border-gray-100 rounded-xl mx-0 mb-5 shadow-sm">
      <div className="flex items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-800">Welcome, Sharon</h1>
        ...
        <div className="flex items-center gap-3">
          {/* Notification bell */}
          <Link href="/notifications" className="relative p-2 rounded-lg hover:bg-gray-50 transition-colors" aria-label="Notifications">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="w-9 h-9 rounded-full bg-[#E8F8F8] overflow-hidden flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#2BBFBF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                </svg>
              </div>
              <span className="text-sm font-medium text-gray-800 hidden sm:block">Sharon</span>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                <Link href="/settings" className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-500 hover:bg-gray-50 transition-colors" onClick={() => setDropdownOpen(false)}>
                ...
                <button className="flex items-center gap-2 w-full px-4 py-2.5 text-sm text-red-500 hover:bg-red-50 transition-colors cursor-pointer">
